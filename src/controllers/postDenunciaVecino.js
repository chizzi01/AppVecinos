const postDenunciaVecino = async (archivos, documentoVecino, idSitio,nombre, descripcion, aceptaResponsabilidad, direccion, ubicacionHecho, token) => {
    try {
...
export default postDenunciaVecino;
